...
%global pkg_name tiago_dual_simulation
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-humble-tiago-dual-simulation
Version:        4.14.0
Release:        1%{?dist}
Summary:        ROS %{pkg_name} package

License:        Apache License 2.0
URL:            https://github.com/pal-robotics/tiago_dual_simulation
...
%description
The tiago_dual_simulation package
...
%changelog
* Mon Sep 07 2026 David ter Kuile <david.terkuile@pal-robotics.com> - 4.14.0-1
- Autogenerated by Bloom

* Thu Aug 20 2026 David ter Kuile <david.terkuile@pal-robotics.com> - 4.13.0-1
- Autogenerated by Bloom
